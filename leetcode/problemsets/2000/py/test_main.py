...
class TestMain(unittest.TestCase):
    def test_brute(self):
        s = main.Solution()
        self.assertEqual("dcbaefd", s.reversePrefix( word = "abcdefd", ch = "d"))
        self.assertEqual("zxyxxe", s.reversePrefix( word = "xyxzxe", ch = "z"))
        self.assertEqual("abcd", s.reversePrefix(word = "abcd", ch = "z"))
