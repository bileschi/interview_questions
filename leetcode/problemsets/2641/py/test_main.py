...
#
# Uses subtests to test two different solutions.
import main
import unittest
...
output_one = TreeNode(
    0, TreeNode(0, TreeNode(7), TreeNode(7)), TreeNode(0, None, TreeNode(11))
)

input_two = TreeNode(3, TreeNode(1), TreeNode(2))
output_two = TreeNode(0, TreeNode(0), TreeNode(0))

input_three = TreeNode(33, TreeNode(37, None, None), TreeNode(42, None, TreeNode(46)))

output_three = TreeNode(0, TreeNode(0, None, None), TreeNode(0, None, TreeNode(0)))
    ...
    def test_replace_value_in_tree_edges(self):
        for s in self.sols:
            with self.subTest(s=s):
                ...
                self.assertTrue(
                    equal_trees(s.replaceValueInTree(TreeNode(1)), TreeNode(0))
                )
